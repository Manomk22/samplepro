...
export class ProjectsService {
  ...
  projects:project[]= [
    ...
    {id: 3, name: "Upcoming projec", pictures: [], projectLink: "", summary: "Project on development", description: "Project on development stage after finished I will post it", tag: []},
    {id: 4, name: "Upcoming projec", pictures: [], projectLink: "", summary: "Project on development", description: "Project on development stage after finished I will post it", tag: []},
    {id: 5, name: "Upcoming projec", pictures: [], projectLink: "", summary: "Project on development", description: "Project on development stage after finished I will post it", tag: []},]
  constructor() { }
